...
def sentiment_chat(text:str, temperature:float=0):
...
def emotion_chat(text:str, temperature:float=0):
...
def positive_chat(text:str, emotion:bool=False, temperature:float=0.8, emot_tempe:float=0, verbose:bool=False, load_memory='Default'):
  if emotion:
...
def negative_chat(text:str, emotion:bool=False, temperature:float=0.8, emot_tempe:float=0, verbose:bool=False, load_memory='Default'):
  if emotion:
    user_emot = emotion_chat(text, temperature = emot_tempe)['emotion']
